...
void sun(){
    ...
    glColor3f(clr(249),clr(215),clr(28));
    circle(2);
...
glColor3f(0.1333333f,0.5450980392f,0.133333333f);
drawstring(-6.50,1,0.0,"Shivansh Gupta ID:201469");
glColor3f(0.1333333f,0.5450980392f,0.133333333f);
drawstring(-6.50,-1,0.0,"Rashik Walia ID:201343");
glFlush();
}
...
glutCreateWindow ("Traffic signal created by Shivansh Gupta and Rashik Walia");
